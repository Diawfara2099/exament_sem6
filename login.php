...
if(isset($_REQUEST['login']))
{
	...
	if(!empty($email) && !empty($pass))
	{
		...
		{
			$error = "<p class='alert alert-warning'>Échec de la connexion</p>";
		}
	}
	else
	{
                	...
                	<div class="loginbox">
                        <div class="login-right">
							<div class="login-right-wrap">
								<h1>Connexion</h1>
								<p class="account-subtitle">Accédez à notre tableau de bord</p>
								...
								<form method="post">
									...
									<div class="form-group">
										...
										<button class="btn btn-primary" name="login" value="Login" type="submit">Se Connecter</button>
								...
								<div class="text-center dont-have">Vous n'avez pas de compte? <a href="register.php">Inscrivez-vous</a></div>
