...
if(isset($_POST['insert'])) {
    ...
    if(!empty($name) && !empty($phone) && !empty($content)) {
        ...
        $sql = "INSERT INTO feedback (uid, fdescription, status, date) VALUES ('$uid', '$content', '0', '$date')";
        $result = mysqli_query($con, $sql);

        if($result) {
            $msg = "<p class='alert alert-success'>Commentaire Sent Successfully</p>";
        } else {
            $error = "<p class='alert alert-warning'>Commentaire Not Sent Successfully</p>";
        }
    } else {
            ...
            <div class="container">
                ...
                <div class="dashboard-personal-info p-5 bg-white">
                    <form action="#" method="post">
                        <h5 class="text-secondary border-bottom-on-white pb-3 mb-4">Formulaire de Message</h5>
