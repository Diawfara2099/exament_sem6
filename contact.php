	...
	if(!empty($name) && !empty($email) && !empty($phone) && !empty($subject) && !empty($message))
	{
		...
		$sql="INSERT INTO contact (name,email,phone,subject,message) VALUES ('$name','$email','$phone','$subject','$message')";
		   ...
		   if($result){
			   ...
			   $error = "<p class='alert alert-warning'>Échec de l'envoi du message</p> ";
		   }
	}else{
...
<div id="page-wrapper">
    <div class="row"> 
							...
							<div class="col-md-12">
								<form class="w-100" action="#" method="post">
									<div class="row">
										...
										<button type="submit" value="send message" name="send" class="btn btn-primary">Envoyer Message</button>
									</div>
								</form>
							</div>
						</div>
        ...
        <!--	Map -->
        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3356.591305771035!2d-17.458612384287145!3d14.711507381035737!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0xeaa2fcbdaf7c3c7%3A0x50a0c56434e1fc2!2sPikine%2C%20Dakar%2C%20S%C3%A9n%C3%A9gal!5e0!3m2!1sen!2sin!4v1594524858625!5m2!1sen!2sin" width="100%" height="450" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
		<!--	Map -->
