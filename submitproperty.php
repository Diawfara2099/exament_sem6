                    ...
                    <div class="col-md-6">
                        <nav aria-label="breadcrumb" class="float-left float-md-right">
                            <ol class="breadcrumb bg-transparent m-0 p-0">
                                ...
                                <li class="breadcrumb-item active">Soumettre une propriété</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                        ...
                        <form method="post" enctype="multipart/form-data">
								<div class="description">
									...
									<?php echo $msg; ?>
										...
										<div class="row">
											...
											<div class="col-xl-6">
												...
												<div class="form-group row">
													...
													<div class="col-lg-9">
													<input type="text" class="form-control" name="bed" required placeholder="Entrez le nombre de chambres (seulement de 1 à 10)">
													</div>
												</div>
												<div class="form-group row">
													<label class="col-lg-3 col-form-label">Balcon</label>
													<div class="col-lg-9">
													<input type="text" class="form-control" name="balc" required placeholder="Entrez le nombre de balcons (seulement de 1 à 10)">
													</div>
												</div>
												<div class="form-group row">
													<label class="col-lg-3 col-form-label">Salon</label>
													<div class="col-lg-9">
													<input type="text" class="form-control" name="hall" required placeholder="Entrez le nombre de Salons (seulement de 1 à 10)">
													</div>
												</div>
												
											</div>
										</div>
										<h5 class="text-secondary">Prix & Location</h5><hr>
										<div class="row">
											<div class="col-xl-6">
												<div class="form-group row">
											...
											<div class="col-xl-6">
												<div class="form-group row">
													<label class="col-lg-3 col-form-label">Total d’étage</label>
													<div class="col-lg-9">
														<select class="form-control" required name="totalfl">
														<option value="">Sélectionner l'Étage</option>
														<option value="1 Floor">1er Étage</option>
														<option value="2 Floor">2e Étage</option>
														<option value="3 Floor">3e Étage</option>
														<option value="4 Floor">4e Étage</option>
														<option value="5 Floor">5e Étage</option>
														<option value="6 Floor">6e Étage</option>
														<option value="7 Floor">7e Étage</option>
														<option value="8 Floor">8e Étage</option>
														<option value="9 Floor">9e Étage</option>
														<option value="10 Floor">10e Étage</option>
														<option value="11 Floor">11e Étage</option>
														<option value="12 Floor">12e Étage</option>
														<option value="13 Floor">13e Étage</option>
														<option value="14 Floor">14e Étage</option>
														<option value="15 Floor">15e Étage</option>

														</select>
													</div>
												</div>
												<div class="form-group row">
														<label class="col-lg-3 col-form-label">Surface de l'aire</label>
														<div class="col-lg-9">
															<input type="text" class="form-control" name="asize" required placeholder="Entrez la taille de l'aire (en m²)">
														</div>
													</div>
										...
										<div class="form-group row">
										<label class="col-lg-2 col-form-label">Caractéristique</label>
										<div class="col-lg-9">
											<p class="alert alert-danger">* Important : Veuillez ne pas supprimer le contenu ci-dessous. Changez uniquement <b>Oui</b> ou <b>Non</b> ou les détails et n'ajoutez pas d'autres informations.</p>
											
											<textarea class="tinymce form-control" name="feature" rows="10" cols="30">
												<!---feature area start--->
												<div class="col-md-4">
													<ul>
														<li class="mb-3"><span class="text-secondary font-weight-bold">Âge de la Propriété : </span>10 Ans</li>
...
<li class="mb-3"><span class="text-secondary font-weight-bold">Capacité de la salle à manger : </span>10 Personnes</li>
...
<div class="col-md-4">
<ul>
<li class="mb-3"><span class="text-secondary font-weight-bold">Tierce partie : </span>Non</li>
...
<!---fin de la zone des caractéristiques---->
</textarea>
</div>
</div>
...
<div class="form-group row">
<label class="col-lg-3 col-form-label">Image du plan d'étage du rez-de-chaussée</label>
<div class="col-lg-9">
...
<!-- Fin de retour en haut de la page --> 
</div>
</div>
